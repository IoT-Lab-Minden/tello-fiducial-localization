...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument('fiducial_len', default_value='0.135'),
        ...
        DeclareLaunchArgument('publish_fiducial_tf', default_value='False'),
        Node(
            ...
            parameters=[
                ...
                {"publish_fiducial_tf":LaunchConfiguration('publish_fiducial_tf')}
            ],
